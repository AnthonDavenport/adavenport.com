        ...
        <div id="wrapper"> <!--Entire body wrapper-->
            <header id="page_header"> <!--The header section-->
                ...
                <div id="theme"> <!--The title or theme of the page.-->
                    <h1>Other Projects</h1><!--<img src="/images/adwd.png" alt="Text that reads, Anthon Davenport Web Designer.">-->
                </div>
            ...
            <div id="content"> <!--The face of the page.  Big Beautiful images to showcase my work.-->
                <img src="/images/artwork/Posterpart3AnthonDavenport5.jpg" alt="The main image is meant to represent some of my other work.">
