        ...
        <div id="wrapper"> <!--Entire body wrapper-->
            <header id="page_header"> <!--The header section-->
                ...
                <div id="theme"> <!--The title or theme of the page.-->
                    <h1>Architecture</h1><!--<img src="/images/adwd.png" alt="Text that reads, Anthon Davenport Web Designer.">-->
                </div>
            ...
            <div id="content"> <!--The face of the page.  Big Beautiful images to showcase my work.-->
                <img src="/images/architecture/Structurestudy5.jpg" alt="The main image is meant to represent some of my architectural work.">
                    <h1>"Architecture"</h1>
            </div>
            <!--<div id="media_boxes"> /Need to add more content later/
                <ul>
                    <li><a href="/pages/artwork.php.php"><img src="/images/artwork/chairstudy2.jpg" alt="The image represents some of my artwork."></a><p>Artwork</p></li>
                    ...
                    <li><a href="/pages/photography.php.php"><img src="/images/photography/foreground.jpg" alt="The image represents some of my photography"></a><p>Photography</p></li>
                </ul>
            </div>-->
